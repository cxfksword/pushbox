    ...
    public static ArrayList<String> getLocalIpv4Addresses(){
        ...
        try{
            ...
            NetworkInterface networkInterface;
                while (networkInterfaces.hasMoreElements() && (networkInterface = networkInterfaces.nextElement()) != null) {
                    Enumeration<InetAddress> inetAddresses = networkInterface.getInetAddresses();
                    try {
                        InetAddress inetAddress;
                            while (inetAddresses.hasMoreElements() && (inetAddress = inetAddresses.nextElement()) != null) {
